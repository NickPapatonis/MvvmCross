...
namespace Playground.Core.G1T
{
    public static class TaskExtensions
    {
        ...
        public static async Task<TResult> WaitAsync<TResult>(this Task<TResult> @this, CancellationToken cancellationToken)
        {
            var delayTask = Task.Delay(-1, cancellationToken);
            var completedTask = await Task.WhenAny(@this, delayTask);
